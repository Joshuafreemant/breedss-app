...
import Bg_img from '../../images/breedss-bunnies.jpg';
                ...
                <section className="homepage" id="home">
                    ...
                    <div className="home__container container grid">
                        <div className="home__data">
                            ...
                            <h1 className="home__data-title">Post Your<br /> <b>Bunnies</b> on Breedss</h1>
                            {/* <h1 className="home__data-title">Breedss Bunnies</h1> */}
                        ...
                        <div className="home__info">
                            <div className="">
                                <span className="home__info-title">Post a Picture/Video of Your Bunnies</span>
