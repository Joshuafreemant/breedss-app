...
import Bg_img from '../../images/breedss-dog.jpg';
                ...
                <section className="homepage" id="home">
                    ...
                    <div className="home__container container grid">
                        <div className="home__data">
                            ...
                            <h1 className="home__data-title">Post Your<br /> <b>Dogs</b> on Breedss</h1>
                            {/* <h1 className="home__data-title">Breedss Dogs</h1> */}
                        ...
                        <div className="home__info">
                            <div className="">
                                <span className="home__info-title">Post a Picture/Video of Your Dogs</span>
