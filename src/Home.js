            ...
            <main className="main">
                <section className="homepage" id="home">
                    ...
                    <div className="home__container container grid">
                        <div className="home__data">
                            ...
                            <NavLink exact to="/signup" className="button">
                                Get Started
                            </NavLink>
                        </div>
                ...
                <section id="more" className="about section">
                    <div className="about__container container grid">
                        <div className="about__data">
                            ...
                            <NavLink exact to="/signup" className="button">Get Started</NavLink>
                ...
                <section className="discover section">
                    ...
                    <section className="experience section">
                        <h2 className="section__title">You're In Good Hands</h2>
                        <div className="experience__container container grid">
                            <div className="experience__content grid">
                                <div className="experience__data">
                                    <h2 className="experience__number"><FaHandshake /> Support</h2>
                                ...
                                <div className="experience__data">
                                    <h2 className="experience__number"><FaLock /> Safe</h2>
                                    <span className="experience__description">
                                ...
                                <div className="experience__data">
                                    <h2 className="experience__number"><FaKey /> Secure</h2>
                                    <span className="experience__description">
